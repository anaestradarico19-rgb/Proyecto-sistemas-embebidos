...
| RF-04 | Activación del actuador | TC-004 | HIL/System | Pendiente |
| RF-05 | Generación de mensajes INFO/WARN/ERROR | TC-005 | Integration | PASS |
| RF-06 | Comunicación I2C | TC-006 | Integration | En validación |
| RF-07 | Comunicación UART | TC-007 | Integration | PASS |
| RF-08 | Actualización de GUI en tiempo real | TC-008 | HIL/System | Pendiente |
| RF-09 | Configuración de umbrales desde GUI | TC-009 | HIL/System | Pendiente |
...
| RNF-03 | Implementación física del sistema | TC-015 | Inspection | Pendiente |
